package com.movie.business.config;
...
public class KafkaConsumerConfig {
    ...
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    @Bean
    public ConsumerFactory<String, VendorData> consumerFactory() {
       Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(VendorData.class));
    }

    @Bean
    public <T> ConcurrentKafkaListenerContainerFactory<?, ?> kafkaListenerJsonFactory() {
        ConcurrentKafkaListenerContainerFactory<String, VendorData> factory = new ConcurrentKafkaListenerContainerFactory<>();
